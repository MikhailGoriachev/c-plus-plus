...
int main()
{
    init(L"Домашнее задание на 30.06.2021");
	...
	MenuItem items[N_MENU] = {
		MenuItem("Задача 1. Данные о жителе города", CMD_TASK_ONE),
		MenuItem("Задача 2. Очередь нуждающихся в улучшении жилищных условий", CMD_TASK_TWO),
