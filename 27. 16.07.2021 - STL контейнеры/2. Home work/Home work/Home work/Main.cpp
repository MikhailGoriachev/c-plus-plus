...
int main()
{
	init(L"Домашнее задание на 15.07.2021");
	...
	MenuItem items[N_MENU] = {
		MenuItem("Задание 1. Чтение файла", CMD_TASK_ONE),
		MenuItem("Задание 2. Вектор с числами", CMD_TASK_TWO),
		MenuItem("Задание 3. Список рабочих", CMD_TASK_THREE),
