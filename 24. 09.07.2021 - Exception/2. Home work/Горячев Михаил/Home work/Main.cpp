...
int main()
{
    init(L"Домашнее задание 12.07.2021");
	...
	MenuItem items[N_MENU] = {
		MenuItem("Задание 1. Работа с массивами вещественных чисел (double)", CMD_TASK_ONE),
		MenuItem("Задание 2. Список рабочих", CMD_TASK_TWO),
