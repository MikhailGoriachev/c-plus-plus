...
#pragma region Методы
	...
	*/
	...
	Conoid& operator++(int)
	{
		// создание временного объекта Conoid
		Conoid* temp = new Conoid;

		// копирование текущего объекта Conoid
		*temp = *this;

		// увеличение полей объекта Conoid на 1
...
#pragma region friend
	...
	friend Conoid& operator--(Conoid& con);
	// декремент Conoid постфиксный
	friend Conoid& operator--(Conoid& con, int);
